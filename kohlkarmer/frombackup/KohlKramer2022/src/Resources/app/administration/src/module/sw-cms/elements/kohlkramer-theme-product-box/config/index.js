...
import template from './sw-cms-el-config-kohlkramer-theme-product-box.html.twig';
import './sw-cms-el-config-kohlkramer-theme-product-box.scss';

const {Component, Mixin} = Shopware;

Component.register('sw-cms-el-config-kohlkramer-theme-product-box', {
    template,
